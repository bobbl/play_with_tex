...
function a_open_out(var f: alpha_file; FileName: string) : boolean;
BEGIN
  assign(f, FileName);
  rewrite(f);
...
function b_open_in(var f: byte_file; FileName: string): boolean;
begin
  assign(f, FileName);
  reset(f);
...
function b_open_out(var f: byte_file; FileName: string): boolean;
begin
  assign(f, FileName);
  rewrite(f);
